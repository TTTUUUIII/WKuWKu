...
public class VbaM extends Emulator {

    static {
        System.loadLibrary("vbam");
    }

    public VbaM(@NonNull Resources resources) {
        super("vbam", EmConfig.fromXml(resources.getXml(R.xml.vba_config)));
    }
