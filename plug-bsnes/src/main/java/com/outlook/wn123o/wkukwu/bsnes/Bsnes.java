...
public class Bsnes extends Emulator {
    ...
    static {
        System.loadLibrary("bsnes");
    }

    public Bsnes(@NonNull Resources resources) {
        super("bsnes", EmConfig.fromXml(resources.getXml(R.xml.bsnes_config)));
    }
