...
public class GenesisPlusGX extends Emulator {
    ...
    public GenesisPlusGX(@NonNull Resources resources) {
        super("genesis-plus-gx", EmConfig.fromXml(resources.getXml(R.xml.genesis_plus_gx_config)));
    }
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (sInstance == null) {
            sInstance = new GenesisPlusGX(resources);
        }
