...
public class GenesisPlusGX extends Emulator {
    ...
    public GenesisPlusGX(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new GenesisPlusGX(resources, R.xml.genesis_plus_gx_config);
    ...
    static {
        System.loadLibrary("genesis-plus-gx");
    }
