...
public class Bsnes extends Emulator {
    public Bsnes(@NonNull Context context) throws XmlPullParserException, IOException {
        super(context.getResources(), R.xml.bsnes_config);
    }
    ...
    public static void registerAsEmulator(@NonNull Context context) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new Bsnes(context);
    ...
    private static Bsnes SHARED_INSTANCE;

    static {
        System.loadLibrary("bsnes-bridge");
    }
