package ink.snowland.wkuwku.plug.yabasanshiro;
...
public class Yabasanshiro extends Emulator {

    static {
        System.loadLibrary("yabasanshiro");
    }

    public Yabasanshiro(@NonNull Resources resources) {
        super("yabasanshiro", EmConfig.fromXml(resources.getXml(R.xml.yabasanshiro_config)));
    }
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (sInstance == null) {
            sInstance = new Yabasanshiro(resources);
        }
