...
public class MesenS extends Emulator {
    ...
    public MesenS(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new MesenS(resources, R.xml.mesen_s_config);
