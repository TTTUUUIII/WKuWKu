...
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativePowerOn(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativePowerOff(JNIEnv *env, jobject thiz) {
    retro_unload_game();
    retro_deinit();
...
extern "C"
JNIEXPORT void JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeReset(JNIEnv *env, jobject thiz) {
    retro_reset();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeLoad(JNIEnv *env, jobject thiz, jstring jpath) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeRun(JNIEnv *env, jobject thiz) {
    retro_run();
}
extern "C"
JNIEXPORT jobject JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeGetSystemAvInfo(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeGetSystemInfo(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeSaveMemoryRam(JNIEnv *env, jobject thiz,
                                                            jstring path) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeLoadMemoryRam(JNIEnv *env, jobject thiz,
                                                            jstring path) {
    bool no_error = false;
    const char *_path = env->GetStringUTFChars(path, JNI_FALSE);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeSaveState(JNIEnv *env, jobject thiz,
                                                        jstring path) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeLoadState(JNIEnv *env, jobject thiz,
                                                        jstring path) {
    bool no_error = false;
    size_t len = retro_serialize_size();
    const char *_path = env->GetStringUTFChars(path, JNI_FALSE);
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    clazz = env->FindClass("ink/snowland/wkuwku/plug/pcsx/Pcsx");
...
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeGetState(JNIEnv *env, jobject thiz) {
    size_t len = retro_serialize_size();
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_pcsx_Pcsx_nativeSetState(JNIEnv *env, jobject thiz, jbyteArray jdata) {
