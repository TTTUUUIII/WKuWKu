...
public class BeetleSaturn extends Emulator {
    ...
    public BeetleSaturn(@NonNull Resources resources) {
        super("beetlesaturn", EmConfig.fromXml(resources.getXml(R.xml.beetlesaturn_config)));
    }
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (sInstance == null) {
            sInstance = new BeetleSaturn(resources);
        }
