...
public class RetroOption implements Cloneable , Comparable<RetroOption>{
    ...
    private RetroOption(@NonNull String key, @NonNull String val, @Nullable String title, boolean enable, String inputType, @Nullable String ...allowVals) {
        this.key = key;
        this.val = val;
        this.title = title;
    ...
    @Override
    public int compareTo(RetroOption o) {
    ...
    public static class Builder {
        ...
        public RetroOption build() {
            return new RetroOption(key, val, title, enable, inputType, allowVals);
        }
    }
    ...
    @NonNull
    @Override
    public RetroOption clone() {
        try {
            return (RetroOption) super.clone();
    ...
    public boolean equals(Object o) {
        ...
        RetroOption option = (RetroOption) o;
