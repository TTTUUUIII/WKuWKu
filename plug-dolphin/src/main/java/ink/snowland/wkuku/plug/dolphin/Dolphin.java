...
public class Dolphin extends Emulator {

    static {
        System.loadLibrary("dolphin");
    }

    public Dolphin(@NonNull Resources resources) {
        super("dolphin", EmConfig.fromXml(resources.getXml(R.xml.dolphin_config)));
    }
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (sInstance == null) {
            sInstance = new Dolphin(resources);
        }
