...
public class SameBoy extends Emulator {
    ...
    public SameBoy(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new SameBoy(resources, R.xml.sameboy_config);
    ...
    private static SameBoy SHARED_INSTANCE;
