    ...
    */
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (theme.resolveAttribute(com.google.android.material.R.attr.colorPrimary, color, true)) {
                buttonColor = styledAttributes.getColor(R.styleable.JoystickView_JV_buttonColor, color.data);
            } else {
                buttonColor = styledAttributes.getColor(R.styleable.JoystickView_JV_buttonColor, DEFAULT_COLOR_BUTTON);
            }
            if (theme.resolveAttribute(com.google.android.material.R.attr.colorOutline, color, true)) {
                borderColor = styledAttributes.getColor(R.styleable.JoystickView_JV_borderColor, color.data);
            } else {
