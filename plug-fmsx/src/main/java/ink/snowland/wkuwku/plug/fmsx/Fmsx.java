...
public class Fmsx extends Emulator {
    ...
    public Fmsx(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new Fmsx(resources, R.xml.fmsx_config);
    ...
    private static Fmsx SHARED_INSTANCE;
