...
public class Yabause extends Emulator {

    public Yabause(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new Yabause(resources, R.xml.yabause_config);
    ...
    private static Yabause SHARED_INSTANCE;
