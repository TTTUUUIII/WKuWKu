package org.wkuwku.plug.swanstation;
...
public class Swanstation extends Emulator {

    static {
        System.loadLibrary("swanstation");
    }

    public Swanstation(@NonNull Resources resources) {
        super("swanstation", EmConfig.fromXml(resources.getXml(R.xml.swanstation_config)));
    }
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (sInstance == null) {
            sInstance = new Swanstation(resources);
        }
