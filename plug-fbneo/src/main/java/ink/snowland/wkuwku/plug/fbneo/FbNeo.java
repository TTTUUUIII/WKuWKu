...
public class FbNeo extends Emulator {
    ...
    public FbNeo(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new FbNeo(resources, R.xml.fbneo_config);
    ...
    private static FbNeo SHARED_INSTANCE;
