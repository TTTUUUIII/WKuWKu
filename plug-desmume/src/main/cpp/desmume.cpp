...
extern "C"
JNIEXPORT void JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeReset(JNIEnv *env, jobject thiz) {
    retro_reset();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeLoad(JNIEnv *env, jobject thiz, jstring jpath) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeRun(JNIEnv *env, jobject thiz) {
    retro_run();
}
extern "C"
JNIEXPORT jobject JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeGetSystemAvInfo(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeGetSystemInfo(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeSaveMemoryRam(JNIEnv *env, jobject thiz,
                                                                              jstring path) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeLoadMemoryRam(JNIEnv *env, jobject thiz,
                                                                              jstring path) {
    bool no_error = false;
    const char *_path = env->GetStringUTFChars(path, JNI_FALSE);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeSaveState(JNIEnv *env, jobject thiz,
                                                                          jstring path) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_ink_snowland_wkuwku_plug_desmume_DeSmuME_nativeLoadState(JNIEnv *env, jobject thiz,
                                                                          jstring path) {
    bool no_error = false;
    size_t len = retro_serialize_size();
    const char *_path = env->GetStringUTFChars(path, JNI_FALSE);
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    clazz = env->FindClass("ink/snowland/wkuwku/plug/desmume/DeSmuME");
