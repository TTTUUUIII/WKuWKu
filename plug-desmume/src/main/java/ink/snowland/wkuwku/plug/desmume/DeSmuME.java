...
public class DeSmuME extends Emulator {
    public DeSmuME(@NonNull Resources res, int configResId) throws XmlPullParserException, IOException {
    ...
    public static void registerAsEmulator(@NonNull Resources resources) {
        if (SHARED_INSTANCE == null) {
            try {
                SHARED_INSTANCE = new DeSmuME(resources, R.xml.desmume_config);
    ...
    private static DeSmuME SHARED_INSTANCE;

    static {
        System.loadLibrary("desmume");
    }
