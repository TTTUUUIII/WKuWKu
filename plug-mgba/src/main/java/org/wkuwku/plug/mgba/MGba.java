...
public class MGba extends Emulator {

    static {
        System.loadLibrary("mgba");
    }

    public MGba(@NonNull Resources resources) {
        super("mgba", EmConfig.fromXml(resources.getXml(R.xml.mgba_config)));
    }
